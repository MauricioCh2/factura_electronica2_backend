...
insert into usuarios (id_usuario,nombre,contrasenia,tipo,tipo_cedula,aprobado) values ('1','pedrito','123','PRO','FIS',true);
insert into usuarios (id_usuario,nombre,contrasenia,tipo,tipo_cedula) values ('2','jairo','1','PRO','FIS');
insert into usuarios (id_usuario,nombre,contrasenia,tipo,tipo_cedula) values ('3','Juana','123','ADM','');


insert into productos ( codigo, descripcion, precio,proveedor_p) values ('001','Queque seco',1500,'1');
insert into productos ( codigo, descripcion, precio,proveedor_p) values ('002','Queque mojado',2000,'1');
